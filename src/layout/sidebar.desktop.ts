...
const asideBaseParts = {
    ...
    surface: 'border-r border-border/60 bg-background md:rounded-r-[2rem]',
...
export const sidebarDesktopLayout = {
    ...
    themeGrid: 'grid gap-2 sm:grid-cols-2',
    ...
    sessionActionsGrid: composeClassParts(sessionActionGridParts),
    ...
    workoutsActionsGrid: composeClassParts(sessionActionGridParts),
    ...
    workoutItemActionsGrid: composeClassParts(sessionActionGridParts),
